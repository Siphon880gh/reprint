...
import {GOOGLE_CLOUD_AUTH, GOOGLE_CLOUD_STORAGE} from "../utils/queries"
...
export default function UploadForm(props) {
    ...
    const {loading, data } = useQuery(GOOGLE_CLOUD_STORAGE);
    // let firebaseConfig = data?.googleCloudStorage || {};
